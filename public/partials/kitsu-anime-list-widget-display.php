            ...
            <li class="item">
                <p>
                    ...
                    <a href="https://kitsu.io/anime/<?php echo $anime['attributes']['slug'] ?>" target="_blank">
                        <img class="kitsu-anime-list-image" src="<?php echo $anime['attributes']['posterImage']['tiny']; ?>" alt="<?php echo $anime['attributes']['canonicalTitle']; ?>" title="<?php echo $anime['attributes']['canonicalTitle']; ?>" />
                    </a>
                </p>
